<template>
  <div class="bonus-container">
    <div class="bonus-header">
      <span class="yellow">&nbsp;&nbsp;精选2016</span>
      <i>&nbsp;&nbsp;▪&nbsp;&nbsp;</i>
      <span>每月一篇精选&nbsp;&nbsp;</span>
    </div>
    <div class="share">
      <span><a href="#"><i class="fa fa-mobile"></i>&nbsp;手机查看</a></span>
      <span><a href="#"><i class="fa fa-wechat"></i>&nbsp;分享到微信</a></span>
      <span><a href="#"><i class="fa fa-weibo"></i>&nbsp;分享到微博</a></span>
      <span><a href="#"><i class="fa fa-facebook"></i>&nbsp;分享到facebook</a></span>
    </div>
    <ul class="text-list">
  ...
  export default {
    ...
    ready: function() {
      this.articles = [{ article: this.texts.Jan }, { article: this.texts.Feb },{ article: this.texts.Mar },
        { article: this.texts.Apr }, { article: this.texts.May }, { article: this.texts.Jun }, { article: this.texts.Jul },
        { article: this.texts.Aug }, { article: this.texts.Sep }, { article: this.texts.Oct }, { article: this.texts.Nov },
        { article: this.texts.Dec }]
    }
  }
</script>
<style>
